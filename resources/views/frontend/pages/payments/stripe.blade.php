...
@section('title') Flipmart - Stripe Payment @endsection
        ...
        <div class="checkout-box ">
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <form action="{{ route('stripe.order.store') }}" method="post" id="payment-form">
                        @csrf
                        <div class="form-row">
...
<script type="text/javascript">
    ...
    var stripe = Stripe('pk_test_51IhS4zSF4jKMyjnKCIOCPAR7GeW22h2rf8IExBhs9gA0gDrvnZbBjba6bBTx7jTGWp0gCXe34hQs7Fc4aHCi5WGL003nBYnGLg');
