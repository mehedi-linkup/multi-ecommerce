...
@section('title') Flipmart - SSL Easy Payment @endsection
                ...
                <div class="col-md-4 order-md-2 mb-4">
                    ...
                    <ul class="list-group mb-3">
                        ...
                        <li class="list-group-item d-flex justify-content-between">
                            <span>Total (BDT)</span>
                            <strong>{{ number_format($total_amount, 2) }} TK</strong>
                        </li>
                    </ul>
                </div>
                    ...
                    <form method="POST" class="needs-validation" novalidate>
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="text" name="customer_name" value="{{ $data['name'] }}" class="form-control" id="customer_name" placeholder=""
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="customer_mobile" value="{{ $data['phone'] }}" class="form-control" id="mobile" placeholder="Mobile"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" name="customer_email" value="{{ $data['email'] }}" class="form-control" id="email"
