...
@section('title') Flipmart - Tracking Order @endsection
                    ...
                    <div class="card-body">
                        <article class="card">
                            <div class="card-body row" style="padding:10px;">
                                ...
                                <div class="col-md-5"> <strong>Shipping By: {{ $order->name }}</strong> <br> {{ $order->division->name }}, {{ $order->district->district_name }},{{ $order->state->state_name }} | <i class="fa fa-phone"></i> {{ $order->phone }}</div>
                            ...
                            <div class="col-md-12">
                                ...
                                <li class="col col-md-3 col-sm-6  mt">
                                    <figure class="itemside mb-3">
                                        <div class="aside"style="height: 50px; width:50px;" ><img src="{{ asset('backend/images/products/'.$item->product->product_image) }}"></div>
                                        <figcaption class="info align-self-center">
                                            <p class="title"> {{  $item->product->name_en  }}  <br>{{ $item->size }} <br> {{ $item->color }}</p> <span class="text-muted"><span class="badge badge-pill badge-primary qty">{{  $item->qty  }} pices</span> </span>
                                        </figcaption>
                                    </figure>
                                </li>
                                @endforeach
