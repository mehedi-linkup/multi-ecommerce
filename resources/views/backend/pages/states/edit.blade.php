        ...
        <div class="col-md-12">
            <div class="card pd-20 pd-sm-40">
                <h6 class="card-body-title">
                    <i class="fa fa-edit"></i> Update State
                        ...
                        <div class="col-xl-12">
                            <div class="card pd-20 pd-sm-40 form-layout form-layout-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                                        <select class="form-control select2-show-search" data-placeholder="Select One" name="division_id">
                                            ...
                                            <option value="{{ $division->id }}" {{ $division->id == $state->division_id ? 'selected' : '' }}>{{ ucwords($division->name) }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="row mg-t-20">
                                    ...
                                    <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                                        <input type="text" name="state_name" value="{{ $state->state_name }}" class="form-control" placeholder="State Name">
