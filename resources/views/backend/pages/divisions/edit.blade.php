        ...
        <div class="col-md-12">
            <div class="card pd-20 pd-sm-40">
                <h6 class="card-body-title">
                    <i class="fa fa-plus"></i> Update Division
                    <a href="{{ route('admin.divisions') }}" class="btn btn-success btn-sm pull-right"><i class="fa fa-list"></i> All Division</a>
                </h6>
                            ...
                            <div class="card pd-20 pd-sm-40 form-layout form-layout-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                                        <input type="text" name="name" class="form-control" value="{{ $division->name }}" placeholder="Division Name">
