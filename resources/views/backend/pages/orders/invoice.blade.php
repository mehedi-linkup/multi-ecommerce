    ...
    <tr>
        ...
        <td>
          <p class="font">
            ...
            Delivery Date: {{ date('d M Y', strtotime($order->delivered_date)) }} <br>
  ...
  <table width="100%">
    ...
    <tbody>
     @foreach ($orderItems as $item)
      <tr class="font">
        <td align="center">
            <img src="{{ public_path('backend/images/products/'.$item->product->product_image) }}" height="60px;" width="60px;" alt="">
        </td>
