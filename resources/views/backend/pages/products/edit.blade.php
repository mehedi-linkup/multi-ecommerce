                            ...
                            <div class="card pd-20 pd-sm-40 form-layout form-layout-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                                        <input type="text" name="name_en" class="form-control" value="{{ $product->name_en }}" placeholder="Name English">
                                ...
                                <div class="row mg-t-20">
                                    ...
                                    <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                                        <input type="text" name="name_bn" class="form-control" value="{{ $product->name_bn }}" placeholder="Name Bangla">
                                ...
                                <div class="row mg-t-20">
                                    ...
                                    <div class="col-sm-6 mg-t-10 mg-sm-t-0">
                                        <input type="text" name="selling_price" class="form-control" value="{{ $product->selling_price }}" placeholder="Product Selling Price">
                                ...
                                <div class="row mg-t-20">
                                    ...
                                    <div class="col-sm-6 mg-t-10 mg-sm-t-0">
                                        <input type="text" name="discount_price" class="form-control" value="{{ $product->discount_price }}" placeholder="Product Discount Price">
                                ...
                                <div class="row mg-t-20">
                                    ...
                                    <div class="col-sm-6 mg-t-10 mg-sm-t-0">
                                        <input type="text" name="tag_en" class="form-control" value="{{ $product->tag_en }}" placeholder="Product Tag English" data-role="tagsinput">
                                ...
                                <div class="row mg-t-20">
                                    ...
                                    <div class="col-sm-6 mg-t-10 mg-sm-t-0">
                                        <input type="text" name="tag_bn" class="form-control" value="{{ $product->tag_bn }}" placeholder="Product Tag Bangla" data-role="tagsinput">
                                ...
                                <div class="row mg-t-20">
                                    ...
                                    <div class="col-sm-6 mg-t-10 mg-sm-t-0">
                                        <input type="text" name="size_en" class="form-control" value="{{ $product->size_en }}" placeholder="Product Size English" data-role="tagsinput">
                                ...
                                <div class="row mg-t-20">
                                    ...
                                    <div class="col-sm-6 mg-t-10 mg-sm-t-0">
                                        <input type="text" name="size_bn" class="form-control" value="{{ $product->size_bn }}" placeholder="Product Size Bangla" data-role="tagsinput">
                                ...
                                <div class="row mg-t-20">
                                    ...
                                    <div class="col-sm-6 mg-t-10 mg-sm-t-0">
                                        <input type="text" name="color_en" class="form-control" value="{{ $product->color_en }}" placeholder="Product Color English" data-role="tagsinput">
                                ...
                                <div class="row mg-t-20">
                                    ...
                                    <div class="col-sm-6 mg-t-10 mg-sm-t-0">
                                        <input type="text" name="color_bn" class="form-control" value="{{ $product->color_bn }}" placeholder="Product Color Bangla" data-role="tagsinput">
                                ...
                                <div class="row mg-t-20">
                                    ...
                                    <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                                        <input type="checkbox" name="hot_deals" value="1" {{ $product->hot_deals == 1 ? 'checked' : '' }}> <span>Check Hot Deals</span>
                                    </div>
                                </div>
                                ...
                                <div class="row mg-t-20">
                                    ...
                                    <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                                        <input type="checkbox" name="featured" value="1" {{ $product->featured == 1 ? 'checked' : '' }}> <span>Check Featured</span>
                                    </div>
                                </div>
                                ...
                                <div class="row mg-t-20">
                                    ...
                                    <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                                        <input type="checkbox" name="special_offer" value="1" {{ $product->special_offer == 1 ? 'checked' : '' }}> <span>Check Special Offer</span>
                                    </div>
                                </div>
                                ...
                                <div class="row mg-t-20">
                                    ...
                                    <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                                        <input type="checkbox" name="special_deals" value="1" {{ $product->special_deals == 1 ? 'checked' : '' }}> <span>Check Special Deals</span>
                                    </div>
                                </div>
                                ...
                                <div class="row mg-t-20">
                                    ...
                                    <div class="col-sm-2">
                                        <img src="{{ asset('backend/images/products/'.$product->product_image) }}" width="60" id="mainThmb">
                                    </div>
                                </div>
                                ...
                                <div class="row mg-t-20">
                                    ...
                                    <div class="col-sm-3" id="showimage">
                                        ...
                                        <img src="{{ asset('backend/images/sub_products/'.$multiImg->images) }}" width="60">
                                        @endforeach
                                    </div>
                                </div>
